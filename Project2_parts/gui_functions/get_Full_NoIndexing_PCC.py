...
def get_Full_NoIndexing_PCC(strings,Query):
    ...
    print("Similarity via PCC with Doc1 : ", PCC( Full_Query_dict , All_aug_vectors_Full[0] ) )
    print("Similarity via PCC with Doc2 : ", PCC( Full_Query_dict , All_aug_vectors_Full[1] ) )
    print("Similarity via PCC with Doc3 : ", PCC( Full_Query_dict , All_aug_vectors_Full[2] ) )
    print("Similarity via PCC with Doc4 : ", PCC( Full_Query_dict , All_aug_vectors_Full[3] ) )
    print("Similarity via PCC with Doc5 : ", PCC( Full_Query_dict , All_aug_vectors_Full[4] ) )
    print("Similarity via PCC with Doc6 : ", PCC( Full_Query_dict , All_aug_vectors_Full[5] ) )
    print("Similarity via PCC with Doc7 : ", PCC( Full_Query_dict , All_aug_vectors_Full[6] ) )
    print("Similarity via PCC with Doc8 : ", PCC( Full_Query_dict , All_aug_vectors_Full[7] ) )
    print("Similarity via PCC with Doc9 : ", PCC( Full_Query_dict , All_aug_vectors_Full[8] ) )
    print("Similarity via PCC with Doc10 : ", PCC( Full_Query_dict , All_aug_vectors_Full[9] ) )
    ...
    for string in strings: 
        ...
        #Key: File Name
        #Value : Similarity
        Similarities[file_name] = PCC( Full_Query_dict , All_aug_vectors_Full[counter] )
        counter+=1
