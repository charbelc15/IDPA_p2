...
def get_IDF_NoIndexing_PCC(strings,Query):
    ...
    print("Similarity via PCC with Doc1 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[0] ) )
    print("Similarity via PCC with Doc2 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[1] ) )
    print("Similarity via PCC with Doc3 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[2] ) )
    print("Similarity via PCC with Doc4 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[3] ) )
    print("Similarity via PCC with Doc5 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[4] ) )
    print("Similarity via PCC with Doc6 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[5] ) )
    print("Similarity via PCC with Doc7 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[6] ) )
    print("Similarity via PCC with Doc8 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[7] ) )
    print("Similarity via PCC with Doc9 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[8] ) )
    print("Similarity via PCC with Doc10 : ", PCC( IDF_Query_dict , All_aug_vectors_IDF[9] ) )
    ...
    for string in strings: 
        ...
        #Key: File Name
        #Value : Similarity
        Similarities[file_name] = PCC( IDF_Query_dict , All_aug_vectors_IDF[counter] )
        counter+=1
