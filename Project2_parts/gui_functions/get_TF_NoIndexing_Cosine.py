...
def get_TF_NoIndexing_Cosine(strings,Query):
    ...
    print("Similarity via Cosine with Doc1 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[0] ) )
    print("Similarity via Cosine with Doc2 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[1] ) )
    print("Similarity via Cosine with Doc3 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[2] ) )
    print("Similarity via Cosine with Doc4 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[3] ) )
    print("Similarity via Cosine with Doc5 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[4] ) )
    print("Similarity via Cosine with Doc6 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[5] ) )
    print("Similarity via Cosine with Doc7 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[6] ) )
    print("Similarity via Cosine with Doc8 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[7] ) )
    print("Similarity via Cosine with Doc9 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[8] ) )
    print("Similarity via Cosine with Doc10 : ", Cosine( TF_Query_dict , All_aug_vectors_TF[9] ) )
    ...
    for string in strings: 
        ...
        #Key: File Name
        #Value : Similarity
        Similarities[file_name] = Cosine( TF_Query_dict , All_aug_vectors_TF[counter] )
        counter+=1
