...
def get_IDF_NoIndexing_Cosine(strings,Query):
    ...
    print()
    print("AugIDF Doc1 \n", (All_aug_vectors_IDF[0]))
    print()
    print("AugIDF Doc2 \n", (All_aug_vectors_IDF[1]))
    print()
    print("AugIDF Doc3 \n", (All_aug_vectors_IDF[2]))
    print()
    print("AugIDF Doc4 \n", (All_aug_vectors_IDF[3]))
    print()
    print("AugIDF Doc5 \n", (All_aug_vectors_IDF[4]))
    print()
    print("AugIDF Doc6 \n", (All_aug_vectors_IDF[5]))
    print()
    print("AugIDF Doc7 \n", (All_aug_vectors_IDF[6]))
    print()
    print("AugIDF Doc8 \n", (All_aug_vectors_IDF[7]))
    print()
    print("AugIDF Doc9 \n", (All_aug_vectors_IDF[8]))
    print()
    print("AugIDF Doc10 \n", (All_aug_vectors_IDF[9]))
    print()
    ...
    print("Similarity via Cosine with Doc1 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[0] ) )
    print("Similarity via Cosine with Doc2 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[1] ) )
    print("Similarity via Cosine with Doc3 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[2] ) )
    print("Similarity via Cosine with Doc4 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[3] ) )
    print("Similarity via Cosine with Doc5 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[4] ) )
    print("Similarity via Cosine with Doc6 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[5] ) )
    print("Similarity via Cosine with Doc7 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[6] ) )
    print("Similarity via Cosine with Doc8 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[7] ) )
    print("Similarity via Cosine with Doc9 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[8] ) )
    print("Similarity via Cosine with Doc10 : ", Cosine( IDF_Query_dict , All_aug_vectors_IDF[9] ) )
    ...
    for string in strings: 
        ...
        #Key: File Name
        #Value : Similarity
        Similarities[file_name] = Cosine( IDF_Query_dict , All_aug_vectors_IDF[counter] )
        counter+=1
