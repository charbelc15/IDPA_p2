...
def get_Full_Indexing_PCC(strings,Query):
    ...
    indexed_Docs = order_docs(keywords_docIDs_Full)
    ...
    for key in indexed_Docs:
        ...
        #Get AugFull
        print("AugFull of Indexed Doc ", file_name, "\n", (All_aug_vectors_Full[key]))
        print()

        #Get Similarity
        Sim = PCC( Full_Query_dict , All_aug_vectors_Full[key])
